@extends('layouts.app')
@section('title', isset($alat) && $alat->exists ? 'Edit Alat' : 'Tambah Alat')
@section('page-title', isset($alat) && $alat->exists ? 'Edit Alat' : 'Tambah Alat')
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-body p-4">
                <form method="POST" action="{{ isset($alat) && $alat->exists ? route('admin.alat.update', $alat) : route('admin.alat.store') }}" enctype="multipart/form-data">
                    @csrf
                    @if(isset($alat) && $alat->exists) @method('PUT') @endif
                    ...
                    <div class="d-flex gap-2 mt-4">
                        <button type="submit" class="btn btn-primary"><i class="bi bi-check-lg me-1"></i>{{ isset($alat) && $alat->exists ? 'Simpan' : 'Tambah' }}</button>
